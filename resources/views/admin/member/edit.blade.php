                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="category_id">
                                @foreach($categories as $category)
                                    @if(old('category_id',$members[0]->category_id) == $category->id)
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="pendidikan_id">
                                @foreach($pendidikans as $pendidikan)
                                    @if(old('pendidikan_id',$members[0]->pendidikan_id) == $pendidikan->id)
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="pekerjaan_id">
                                @foreach($pekerjaans as $pekerjaan)
                                    @if(old('pekerjaan_id',$members[0]->pekerjaan_id) == $pekerjaan->id)
