    ...
    <div class="container container-fluid d-flex justify-content-center">
        <div class="col-md-8 ">
            <div class="portlet light bordered">
                    <div class="form-body">
                        <form action="/peminjaman/{{ $peminjamans[0]->id }}" method="post">
                        @method('put')
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal')
                                is-invalid
                            @enderror" id="tanggal" name="tanggal" placeholder="Masukan tanggal..." autofocus required value="{{ old('tanggal',$peminjamans[0]->tanggal) }}">
                            @error('tanggal')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="member_id">
                                @foreach($members as $member)
                                    @if(old('member_id',$peminjamans[0]->member_id) == $member->id)
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="koleksi_id">
                                @foreach($koleksis as $koleksi)
                                    @if(old('koleksi_id',$peminjamans[0]->koleksi_id) == $koleksi->id)
