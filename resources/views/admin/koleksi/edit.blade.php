    ...
    <div class="container container-fluid d-flex justify-content-center">
        <div class="col-md-8 ">
            <div class="portlet light bordered">
                    <div class="form-body">
                        <form action="/koleksi/{{ $koleksis[0]->id }}" method="post">
                        @method('put')
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama')
                                is-invalid
                            @enderror" id="nama" name="nama" placeholder="Enter Koleksi..." autofocus required value="{{ old('nama',$koleksis[0]->nama) }}">
                            @error('nama')
                        ...
                        <div class="mb-3">
                            ...
                            <input id="klasifikasi" type="hidden" name="klasifikasi" value="{{ old('klasifikasi',$koleksis[0]->klasifikasi) }}">
